...
private:
  ...
  string _input_config_path;	// Initial configuration path
  ...
  bool _measure_penergy, _measure_penergy_instant, _measure_kenergy, _measure_tenergy;// Flags for measuring different energies
  bool _measure_temp, _measure_pressure, _measure_gofr, _measure_tails;     // Flags for measuring temperature, pressure, and radial dist. function
...
public: // Function declarations
  ...
  void seek_temperature(); 	// Equilibrate the system
  void change_vel(double hot_cold); // heat or cool the system
  ...
  void read_config_path();		// Read intial configuration path for restart 
