...
double Random :: Exponential(double gamma) {
   // This function generates a random number froam an Exponential distribution
   return -log(1.0 - Rannyu())/gamma;
}

double Random :: CauchyLorentz(double mean, double gamma) {
   // This function generates a random number froam a Cauchy-Lorentz distribution
